...
class SpinnerGroupTwentyOneAdapter(
  private val mContext: Context,
  @LayoutRes
  private val layoutResource: Int,
  private val allItems: List<SpinnerGroupTwentyOneModel>
) : ArrayAdapter<SpinnerGroupTwentyOneModel>(mContext, layoutResource, allItems) {
