package com.adityasapplication.app.modules.menu.`data`.model
...
data class MenuModel(
   ...
   * TODO Replace with dynamic value
   */
  var txtQnASection: String? = MyApp.getInstance().resources.getString(R.string.lbl_qna_section)
  ,
  /**
   * TODO Replace with dynamic value
   */
  var txtMentorConnect: String? =
      MyApp.getInstance().resources.getString(R.string.lbl_mentor_connect)
  ,
  /**
   * TODO Replace with dynamic value
   */
  var txtCommunitySecti: String? =
      MyApp.getInstance().resources.getString(R.string.msg_community_secti)
  ,
  /**
   * TODO Replace with dynamic value
   */
  var txtAboutus: String? = MyApp.getInstance().resources.getString(R.string.lbl_about_us2)
  ,
  /**
   * TODO Replace with dynamic value
   */
  var txtBecomeAMentor: String? =
      MyApp.getInstance().resources.getString(R.string.lbl_become_a_mentor)
  ,
  /**
   * TODO Replace with dynamic value
   */
   ...
   * TODO Replace with dynamic value
   */
  var etGroupSixtySevenValue: String? = null
)
