...
class SpinnerGroupTwentyTwoAdapter(
  private val mContext: Context,
  @LayoutRes
  private val layoutResource: Int,
  private val allItems: List<SpinnerGroupTwentyTwoModel>
) : ArrayAdapter<SpinnerGroupTwentyTwoModel>(mContext, layoutResource, allItems) {
