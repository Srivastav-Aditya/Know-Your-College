...
class SpinnerGroupFortyFourAdapter(
  private val mContext: Context,
  @LayoutRes
  private val layoutResource: Int,
  private val allItems: List<SpinnerGroupFortyFourModel>
) : ArrayAdapter<SpinnerGroupFortyFourModel>(mContext, layoutResource, allItems) {
