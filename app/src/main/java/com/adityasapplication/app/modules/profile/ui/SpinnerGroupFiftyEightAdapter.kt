...
class SpinnerGroupFiftyEightAdapter(
  private val mContext: Context,
  @LayoutRes
  private val layoutResource: Int,
  private val allItems: List<SpinnerGroupFiftyEightModel>
) : ArrayAdapter<SpinnerGroupFiftyEightModel>(mContext, layoutResource, allItems) {
