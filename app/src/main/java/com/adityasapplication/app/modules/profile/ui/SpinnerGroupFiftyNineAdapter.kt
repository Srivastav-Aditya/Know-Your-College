...
class SpinnerGroupFiftyNineAdapter(
  private val mContext: Context,
  @LayoutRes
  private val layoutResource: Int,
  private val allItems: List<SpinnerGroupFiftyNineModel>
) : ArrayAdapter<SpinnerGroupFiftyNineModel>(mContext, layoutResource, allItems) {
