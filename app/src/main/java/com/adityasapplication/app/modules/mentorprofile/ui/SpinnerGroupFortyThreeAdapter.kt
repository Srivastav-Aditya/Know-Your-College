...
class SpinnerGroupFortyThreeAdapter(
  private val mContext: Context,
  @LayoutRes
  private val layoutResource: Int,
  private val allItems: List<SpinnerGroupFortyThreeModel>
) : ArrayAdapter<SpinnerGroupFortyThreeModel>(mContext, layoutResource, allItems) {
